...
3. PID resolution can content-negotiate to Datacite’s PID metadata \[FDOF2] or use [FAIR Signposting](https://signposting.org/FAIR/) to find an RO-Crate containing the workflow \[FDOF3] and richer JSON-LD metadata resources \[FDOF5,FDOF8], see Fig. 1
